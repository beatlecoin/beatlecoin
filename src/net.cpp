...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Beatlecoin " + FormatFullVersion();
...
{"beatlecoin.com", "dnsseed.beatlecoin.com"},
{"beatlecoin.net", "dnsseed.beatlecoin.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
{"beatlecoin.com", "testnet-seed.beatlecoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Beatlecoin is probably already running."), addrBind.ToString().c_str());
        else
